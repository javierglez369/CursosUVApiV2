...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260413165945_IdentityRefreshToken'
)
BEGIN
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Estudiantes_UserId] ON [Estudiantes] ([UserId]) WHERE [UserId] IS NOT NULL');
END;
